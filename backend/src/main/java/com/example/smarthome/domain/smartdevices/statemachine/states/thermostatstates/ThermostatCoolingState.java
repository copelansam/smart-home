...
/**
 * Concrete state representing a thermostat in the "cooling" state.
 *
 * <p>
 * This state is part of the smart thermostat state machine. It defines:
 * <ul>
 *     <li>Which transitions are allowed while the thermostat is cooling</li>
...
public class ThermostatCoolingState extends StateBase<SmartThermostat> {
     ...
     * reconstructed from its string representation ("Thermostat Cooling").
     */
    static {
    ...
    /**
     * Constructs the Thermostat Cooling state with:
     * <ul>
     *     <li>Allowed transition: STOP_COOLING, POWER_THERMOSTAT_OFF</li>
    ...
    /**
     * Executes a transition while the device is in the cooling state.
     *
     * <p>
     * Supported transitions:
     * <ul>
     *     <li>STOP_COOLING → transitions device to {@link ThermostatIdleState}</li>
    ...
    public CallResult execute(String transition, SmartThermostat device, Map<String, Object> parameters){
        ...
        switch (action){
            ...
            case STOP_COOLING:
                // Stop cooling by transitioning device to idle state
